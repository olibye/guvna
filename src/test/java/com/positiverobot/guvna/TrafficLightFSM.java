...
/**
 * Here's the way I want to layout my state machines. I use the
 * eclipse @formatter on/off in comments around my state transition matrix.
 *
...
public class TrafficLightFSM extends StateMachine<TrafficLightFSM.s, TrafficLightFSM.e> {
     ...
     * shouldn't store individual state in the plan. Your FSM will be passed into
